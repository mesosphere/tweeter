...
object SparkCassandraTest {
  ...
  val stoplist = new HashSet[String]() ++ ("a,able,about,across,after,all,almost,also,am,among,an," +
    "and,any,are,as,at,be,because,been,but,by,can,cannot,could,dear,did,do,does,either,else,ever,every,for,from,get," +
    "got,had,has,hath,have,he,her,hers,him,his,how,however,i,if,in,into,is,it,its,just,least,let,like,likely,may,me," +
    "might,more,most,must,my,neither,no,nor,not,of,off,often,on,only,or,other,our,own,rather,said,say,says,shall,she," +
    "should,since,so,some,than,that,the,their,them,then,there,these,they,this,thou,thy,tis,to,too,twas,upon,us,wants," +
    "was,we,well,were,what,when,where,which,while,who,whom,why,will,with,would,yet,you,your").split(",")
