...
object SparkCassandraTest {
  ...
  val stoplist: HashSet[String] = new HashSet[String]() ++ ("a,able,about,across,after,all,almost,also,am,among,an," +
    "and,any,are,as,at,be,because,been,but,by,can,cannot,could,dear,did,do,does,either,else,ever,every,for,from,get," +
    "got,had,has,have,he,her,hers,him,his,how,however,i,if,in,into,is,it,its,just,least,let,like,likely,may,me,might," +
    "most,must,my,neither,no,nor,not,of,off,often,on,only,or,other,our,own,rather,said,say,says,she,should,since,so," +
    "some,thanthat,the,their,them,then,there,these,they,this,tis,to,too,twas,us,wants,was,we,were,what,when,where," +
  ...
  def main(args: Array[String]) {
    ...
    val freqs = words
      ...
      .filter(t => t != "" && !stoplist.contains(t._1)) //remove items in stoplist
